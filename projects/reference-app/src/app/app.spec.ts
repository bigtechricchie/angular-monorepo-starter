...
describe('App', () => {
  ...
  it('renders the Reference App heading', () => {
    const heading = fixture.debugElement.query(By.css('h1'));

    expect(heading.nativeElement.textContent).toContain('Reference App');
  });
  ...
  it('renders links to Home and Health', () => {
    ...
    expect(healthLink.nativeElement.textContent).toContain('Health');
  });
});
